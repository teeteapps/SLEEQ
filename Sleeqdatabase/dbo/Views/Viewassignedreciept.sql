...
AC.Hiringdays,AC.Hiringprice,Ac.Hireamount,AC.Carwash ,  
(Ac.Hireamount + AC.Carwash) AS Totalhireamount,
CASE WHEN AC.Carstatus=1 THEN 'Hired' ELSE 'Parked' END AS Carstatus,AC.Ispaid,AC.Isextended,
